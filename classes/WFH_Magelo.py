...
class WFH_Magelo:
  def __init__(self):
    ...
    "HoH Trial, RD":{"Text":"You have completed Trydan Faye's trial by defeating Rydda'Dar.","Requirement":["AerinDar"],"Level":55},
    "HoH Trial, Villagers":{"Text":"You have completed Rhaliq Trell's trial by saving the villagers.","Requirement":["AerinDar"],"Level":55},
    "HoH Trial, Maidens":{"Text":"You have completed Alekson Garn's trial by protecting the maidens.","Requirement":["AerinDar"],"Level":55},
